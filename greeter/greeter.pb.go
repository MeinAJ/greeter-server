...
const file_greeter_proto_rawDesc = "" +
	...
	"\aGreeter\x127\n" +
	"\bSayHello\x12\x14.greeter.SayHelloReq\x1a\x15.greeter.SayHelloRespB\vZ\t./greeterb\x06proto3"
...
var file_greeter_proto_goTypes = []any{
	(*SayHelloReq)(nil),  // 0: greeter.SayHelloReq
	(*SayHelloResp)(nil), // 1: greeter.SayHelloResp
}
var file_greeter_proto_depIdxs = []int32{
	0, // 0: greeter.Greeter.SayHello:input_type -> greeter.SayHelloReq
	1, // 1: greeter.Greeter.SayHello:output_type -> greeter.SayHelloResp
